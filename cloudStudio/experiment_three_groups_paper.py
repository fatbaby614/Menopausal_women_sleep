...
if IS_WINDOWS:
    ...
    ISRUC_DIR = r"/mnt/data1/home/tanhuang/datasets/ISRUC-SLEEP"
    DREAMS_DIR = r"/mnt/data1/home/tanhuang/datasets/DREAMS/DatabasePatients"
    OUTPUT_DIR = r"./experiment_results"
    MENOPAUSAL_JSON = r"json/menopausal_women_subjects.json"
    YOUNG_WOMEN_JSON = r"json/young_women_control_group.json"
    YOUNG_MEN_JSON = r"json/young_men_control_group.json"
...
SLEEP_EDF_GROUP_CONFIG = {
    'menopausal_women': {
        'name': 'Menopausal Women', 'age_range': (45, 55), 'gender': 'F',
...
DREAMS_GROUP_CONFIG = {
    'menopausal_women': {
        'name': 'Menopausal Women', 'age_range': (45, 55), 'gender': 'F',
        'subject_ids': ['subject2', 'subject4', 'subject5', 'subject7', 'subject12']
    },
    'young_women': {
...
def run_single_group_experiment(X, y, group_name, group_config,
    ...
    n_splits = min(5, len(np.unique(subject_ids_arr))) if subject_ids_arr is not None else 5
    ...
    groups = subject_ids_arr if subject_ids_arr is not None else np.arange(len(y))
...
def run_comparative_experiment():
    ...
    print("Evaluation: 5-fold Group Cross-Validation")
    print("=" * 70)
